...
def run_scenario_4():
    ...
    # Create appeal
    appeal1 = Appeal(appealantAddress=addresses_pool[15])
    ...
    print(f"  Rotations: {transaction_budget.rotations}")
    print(
        f"  Appealant: {appeal1.appealantAddress[:8]}...{appeal1.appealantAddress[-6:]}\n"
    )
...
if __name__ == "__main__":
    ...
    print(
        f"{Colors.YELLOW}(Note: Each scenario tests different aspects of fee distribution logic){Colors.ENDC}"
    )
